...
public class HomeActivity extends AppCompatActivity {
    ...
    private Button btn,phy,russ,match,chem,soci;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soci = findViewById(R.id.btn_soci);
        soci.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(".soci");
                        startActivity(intent);
                    }
                }
        );

        chem = findViewById(R.id.btn_chem);
        chem.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(".chem");
                        startActivity(intent);
                    }
                }
        );
        ...
        match.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(".match");
                        startActivity(intent);
                    }
                }
        );

        russ = findViewById(R.id.btn_russ);
        russ.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(".russ");
                        startActivity(intent);
                    }
                }
        );

        phy = findViewById(R.id.btn_phiz);
        phy.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(".phy");
                        startActivity(intent);
                    }
                }
        );
